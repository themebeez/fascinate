wp.customize.controlConstructor['fascinate-typography'] = wp.customize.Control.extend({
    ...
    ready: function () {
        ...
        let fontFamilySelectEle = control.container.find('#fascinate-font-family-select-' + control.id);
        if (fontFamilySelectEle.length > 0) {
            new SlimSelect({
                select: '#fascinate-font-family-select-' + control.id,
                showSearch: true,
        ...
        let fontVariantsSelectEle = control.container.find('#fascinate-font-variants-select-' + control.id);
        if (fontVariantsSelectEle.length > 0) {
            new SlimSelect({
                select: '#fascinate-font-variants-select-' + control.id,
                showSearch: false,
                contentPosition: 'relative',
                settings: {
                    openPosition: 'down' // 'auto', 'up' or 'down'
        ...
        let fontWeightSelectEle = control.container.find('#fascinate-font-weight-select-' + control.id);
        if (fontWeightSelectEle.length > 0) {
            new SlimSelect({
                select: '#fascinate-font-weight-select-' + control.id,
                showSearch: false,
                contentPosition: 'relative',
                settings: {
                    openPosition: 'down' // 'auto', 'up' or 'down'
        ...
        fontFamilySelectEle.on('change', function () {
            ...
            let fontVariantsSelectWrapperEle = jQuery('#fascinate-google-variants-select-wrapper-' + thisFontFamilySelectEle.data('control'));
        ...
        body.on('change', '#fascinate-font-family-select-' + control.id, function (event) {
            ...
            if (fontSource === 'google') {
                ...
                let fontURLEle = jQuery('#fascinate-font-url-' + control.id);
        ...
        body.on('change', '#fascinate-font-variants-select-' + control.id, function (event) {
            event.preventDefault();
            let thisEle = jQuery(this);
        ...
        body.on('change', '#fascinate-font-weight-select-' + control.id, function (event) {
            event.preventDefault();
            let thisEle = jQuery(this);
        ...
        devices.forEach(function (device) {
            ...
            // On font-size change.
            body.on('change', '#fascinate-' + device + '-font-size-' + control.id, function (event) {
                event.preventDefault();
                let thisEle = jQuery(this);
                let settingValue = getSettingValue(control.id);
            ...
            body.on('change', '#fascinate-' + device + '-font-size-unit-input-' + control.id, function (event) {
                event.preventDefault();
                let thisEle = jQuery(this);
                let settingValue = getSettingValue(control.id);
                let targetDevice = thisEle.data('device');

                let fontSizeInputEle = jQuery('#fascinate-' + targetDevice + '-font-size-' + control.id);
            ...
            body.on('change', '#fascinate-' + device + '-line-height-' + control.id, function (event) {
                event.preventDefault();
                let thisEle = jQuery(this);
                let settingValue = getSettingValue(control.id);
                let targetDevice = thisEle.data('device');
            ...
            body.on('change', '#fascinate-' + device + '-letter-spacing-' + control.id, function (event) {
                event.preventDefault();
                let thisEle = jQuery(this);
                let settingValue = getSettingValue(control.id);
                let targetDevice = thisEle.data('device');
            ...
            body.on('change', '#fascinate-' + device + '-letter-spacing-unit-input-' + control.id, function (event) {
                event.preventDefault();
                let thisEle = jQuery(this);
                let settingValue = getSettingValue(control.id);
                let targetDevice = thisEle.data('device');

                let letterSpacingInputEle = jQuery('#fascinate-' + targetDevice + '-letter-spacing-' + control.id);
        ...
        body.on('change', '#fascinate-typography-font-style-input-' + control.id, function (event) {
            event.preventDefault();
            let thisEle = jQuery(this);
            let settingValue = getSettingValue(control.id);
        ...
        body.on('change', '#fascinate-typography-text-transform-input-' + control.id, function (event) {
            event.preventDefault();
            let thisEle = jQuery(this);
            let settingValue = getSettingValue(control.id);
        ...
        let fontSizeSliders = [
            control.container.find('.fascinate-slider.fascinate-slider-font-size.desktop-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-font-size.tablet-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-font-size.mobile-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-font-size.normal-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-line-height.desktop-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-line-height.tablet-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-line-height.mobile-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-line-height.normal-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-letter-spacing.desktop-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-letter-spacing.tablet-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-letter-spacing.mobile-slider'),
            control.container.find('.fascinate-slider.fascinate-slider-letter-spacing.normal-slider')
        ];

        // Initialize sliders using jQuery slider UI.
        fontSizeSliders.forEach(function (fontSizeSlider) {
            let fontSizeSliderInput = fontSizeSlider.next('.fascinate-slider-input').find('input.slider-input');
        ...
        body.on('click', '#fascinate-text-style-reset-' + control.id, function (event) {
            event.preventDefault();
            // Reset text-style input value.
            let textStyleInputEle = jQuery('#fascinate-typography-font-style-input-' + control.id);
            ...
            let textStyleButton = jQuery('#fascinate-font-style-' + textStyleDefaultValue + '-' + control.id);
            textStyleButton.addClass('active').siblings().removeClass('active');
        });

        // On text-transform reset event.
        body.on('click', '#fascinate-text-transform-reset-' + control.id, function (event) {
            event.preventDefault();
            // Reset text-transform input value.
            let textTransformInputEle = jQuery('#fascinate-typography-text-transform-input-' + control.id);
            ...
            let textTransformButton = jQuery('#fascinate-text-transform-' + textTransformDefaultValue + '-' + control.id);
        ...
        function saveSetting(controlID, newSettingValue) {
            let settingInputEle = jQuery('#fascinate-typography-control-value-' + controlID);
