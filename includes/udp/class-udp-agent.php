...
class Udp_Agent {
	...
	public function on_admin_init() {
		...
		add_settings_field(
			'udp_agent_allow_tracking',
			esc_html__( 'Allow Anonymous Tracking', 'fascinate' ),
	...
	public function show_settings_ui() {
		...
		echo '/>';
		echo esc_html__( 'Become a super contributor by sharing your non-sensitive WordPress data. We guarantee no sensitive data is collected.', 'fascinate' );
		echo wp_kses_data( '<a href="https://creamcode.org/user-data-processing/" target="_blank" > ' . esc_html__( ' What data do we collect?', 'fascinate' ) . '</a>' );
		echo ' </p>';
	}
