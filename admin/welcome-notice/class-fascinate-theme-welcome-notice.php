...
if ( ! class_exists( 'Fascinate_Theme_Welcome_Notice' ) ) {
	/**
	 * Class - Theme Notice.
	 *
	 ...
	 * @since 1.0.0
	 */
	class Fascinate_Theme_Welcome_Notice {
				...
				<div class="theme-notice__content">
						...
						<div class="theme-notice__head">
							...
							<h2 class="theme-notice__heading">
								...
								printf(
									...
									esc_html__( 'Welcome to %s', 'fascinate' ),
							...
							<p class="theme-notice__description">
								...
								printf(
									...
									esc_html__( 'Thank you for choosing %1$s! To get started with %1$s and import starter templates, install Themebeez Toolkit plugin by clicking on the button below! We hope you enjoy using %1$s.', 'fascinate' ),
									esc_html( $this->theme_name )
								);
								?>
							</p>
							...
							<p>
								<button id="get-started-btn" class="theme-notice__button button button-primary">
									<span class="button-text">
										<?php echo esc_html__( 'Get Started', 'fascinate' ); ?>
									</span>
					...
					<div class="theme-notice__image">
						<img
							...
							alt="<?php echo esc_attr__( 'Notice Image', 'fascinate' ); ?>"
						>
					</div>
				</div>
			</div>
